		...
		<nav class='' id='main-nav'>
			<div class='navigation'>
				...
				<ul id='navigation-menu' class='nav nav-stacked'>
					<li class=''><a href='${ctx}/main/welcomePage'> <i
										...
										success : function(data) {
											$
													.each(
															...
															function(i,
																	parentMenu) {
																menusTxt += " <li class=''><a  target='mainFrame' class='dropdown-collapse  in' href='"+parentMenu.url+"'><i class='"+parentMenu.log+"'></i><span>"
																		+ parentMenu.menuName
																		+ "</span></a><ul class='nav nav-stacked'>";
																var sonMenuArr = parentMenu.menuList;
																for (var i = 0; i < sonMenuArr.length; i++) {
																	menusTxt += "<li><a  target='mainFrame' href='${ctx}/"+sonMenuArr[i].url+"'><i class='"+sonMenuArr[i].log+"'></i><span>"
