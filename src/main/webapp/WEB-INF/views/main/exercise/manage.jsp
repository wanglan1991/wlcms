...
<div class='modal hide fade' id='modal-addExercise' role='dialog' tabindex='-1' style= "overflow: overlay;width:65%;height:80%;left: 35%;">
    <div class='modal-header'>
        ...
        <h3></h3>
            ...
            <div style="margin-left: 36%;margin-top:-54%;width:62%;;height: 450px;">
...
<div class='modal hide fade' id='modal-editExercise' exerciseId='' role='dialog' tabindex='-1' style= "overflow: overlay;width:65%;height:80%;left: 35%;">
    <div class='modal-header'>
