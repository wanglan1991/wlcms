...
<div class='modal hide fade' id='modal-preview' role='dialog' tabindex='-1' style= "width:45%;height:80%;overflow: auto;left: 42%;">
   ...
   <div id="exerciseContent"  style="margin-left: 56px;margin-top: 29px;">
    ...
    <hr>
    <h4 style="margin-left:56px"><b>解析:</b></h4>
    <div id="exerciseAnalysis" style="width: 70%;margin-left:100px;height: 20%;"></div>
      	</div>
</div>
        ...
        <h3></h3>
            ...
            <div style="margin-left: 36%;margin-top:-40%;width:62%;;height: 450px;">
             <div class='control-group'>
	            <div class='controls'>
	                ...
	                <form id="upload"  enctype="multipart/form-data">
						...
						<div><button type="submit" id ="submitbutton">图片上传</button><input type=button value="复制" onclick="jsCopy('url')">
						 <input id='url'  maxlength='100'  placeholder='&lt; &frasl;&nbsp;&frasl;img.png &frasl;&nbsp;&frasl; &gt;图片文件名' type='text' /></div>
					</form>
	            </div>
	        </div>
            	...
            	<div id="answer">
            		 <p style='color:red;'>请使用,例如：“<b style='color:blue'>&lt;&frasl;&nbsp;&frasl; img.png&frasl;&nbsp;&frasl; &gt;</b>”来标注图片在习题内容以及习题答案中的显示位置。
            		 </br>上标请使用<b style='color:blue'>H&lt;sup&gt;3&lt;&frasl;sup&gt;:H<sup>3</sup></b>，
            		 下标请使用<b style='color:blue'>H&lt;sub&gt;3&lt;&frasl;sub&gt;:H<sub>3</sub></b>。
            		 请严格遵守此规范</p>
	            ...
	            <div class='controls'>
					...
					<input type="file" id="editExeFile" name="editExeFile" multiple="multiple"	 required>
						...
						<div><button type="submit" id ="editSubmitbutton">图片上传</button><input type=button value="复制" onclick="jsCopy('editUrl')">
						 <input id='editUrl'  maxlength='100'  placeholder='&lt; &frasl;&nbsp;&frasl;img.png &frasl;&nbsp;&frasl; &gt;图片文件名' type='text' /></div>
			</form>
	            </div>
	        </div>
