...
<!-- </div> -->
<!-- 新增字典模态框 -->
<div class='modal hide fade' id='modal-DictTree' role='dialog' tabindex='-1'>
    ...
    <div class='modal-body'>
       <div class='control-group'>
            ...
            <div class='controls'>
                <input class='span8' id='value'  required  placeholder='字典值' type='text' />
            </div>
        </div>
        <div class='control-group'>
         ...
         <div class='control-group'>
            ...
            <div class='controls'>
                <input class='span8' id='type' required placeholder='字典类型' type='text' />
            </div>
        </div>
<!--          <div class='control-group' > -->
...
<!-- 编辑字典模态框 -->
<div class='modal hide fade' id='modal-EditDict' role='dialog' tabindex='-1'>
    <div class='modal-header'>
    ...
    <div class='modal-body'>
        <div class='control-group'>
            <label class='control-label'>字典值</label>
            <div class='controls'>
                 <input class='span8' id='EditValue'  name="value" valueId='' required  placeholder='字典值' type='text' />
            </div>
        </div>
         <div class='control-group'>
            <label class='control-label'>父级ID</label>
            <div class='controls'>
                <input class='span8' id='EditParentID' name="parentId"   placeholder='父级ID' type='text' />
            </div>
        </div>
          <div class='control-group'>
            <label class='control-label'>类型</label>
            <div class='controls'>
                <input class='span8' id='EditType' name="type"   placeholder='类型' type='text' />
            </div>
        </div>
         <div class='control-group'>
            <label class='control-label'>备注</label>
            <div class='controls'>
                <input class='span8' id='EditRemark' name="remark"   placeholder='备注' type='text' />
            </div>
        </div>
    </div>
    <div class='modal-footer'>
