...
define(function(require, exports, module) {
	...
	var F = module.exports = {
		table : new core.Table('newsTable'),
		init : function(_basepath) {
			...
			if (base.perList.news.del) {
				$("#newsActions").append("&nbsp;&nbsp;<a href='#' id='delSelectNews'  class='btn btn-danger btn-small' "
			 ...
			 * 用户列表
			 */
			F.table.init(F.basepath + '/news/listPage', cols);
			...
			//监听回车按下查询事件
			document.getElementById("newsActions").onkeydown =keyDownSearch;
			...
			function query() {
				var title = $("#keyword").val();
					...
					$('#newsTable').bootstrapTable('refresh', {url : query_url});
